...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="css_proyecto/estilo.css">
  ...
  <body>
        ...
        <div class="hero">
          <video autoplay loop muted plays-inline class="back-video">
            <source src="assets/video/Surf - 29497.mp4"> 
          </video>
          <nav>
            <div>
                <img src="assets/imagenes/logo_aloha_wind.png" style="max-width: 100%;height:auto;" class="logo">

            </div>
          </nav>
          <div class="content">
            <h1 style="font-size: 10vW">Aloha-Wind</h1>
            <a href="/login/iniciar_sesion/iniciar_sesion.html"> Comenzar </a>
          </div>
