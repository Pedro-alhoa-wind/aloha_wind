...
<div class="container">
    ...
    <h1>ALQUILER MATERIALES WINDSURF</h1>
...
?>   
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">        
                                <table id="tablaAlquilerMaterialWindsurf" class="table table-striped table-bordered table-condensed" style="width:100%">
        ...
        <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <form id="formAlquilerMaterialWindsurf">    
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                        <label for="velas" class="col-form-label">Tipo vela:</label>
                        <input type="text" class="form-control" id="velas">
                        </div>                
                        <div class="form-group">
...
<!-- FIN CRUD -->
    ...
    <script src="/pagina_admin/main/main_alquiler_materiales_windsurf.js"></script>
