...
$consulta = "SELECT id, monitor, clase, fecha, hora FROM reservas_clases_surf";
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">        
                                <table id="tablaReservaClaseSurf" class="table table-striped table-bordered table-condensed" style="width:100%">
