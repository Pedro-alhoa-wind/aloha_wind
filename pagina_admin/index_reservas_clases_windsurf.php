...
<div class="container">
    ...
    <h1>RESERVAS CLASES WINDSURF</h1>
...
$consulta = "SELECT id, monitor, clase, fecha, hora FROM reservas_clases_windsurf";
...
?>   
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive">        
                                <table id="tablaReservaClaseWindsurf" class="table table-striped table-bordered table-condensed" style="width:100%">
        ...
        <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <form id="formReservaClaseWindsurf">    
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                        <label for="clase" class="col-form-label">Tipo clase:</label>
...
<!-- FIN CRUD -->
    ...
    <script src="/pagina_admin/main/main_reservas_clases_windsurf.js"></script>
