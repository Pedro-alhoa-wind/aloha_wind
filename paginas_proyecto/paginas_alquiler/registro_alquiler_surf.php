    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                Has realizado el alquiler de una tabla tipo <?php  echo $tablas; ?> y un neopreno de la talla <?php echo $neoprenos; ?> para el día <?php echo $fecha; ?>  a las <?php echo $hora; ?> h. 
                </p>
                <br>
